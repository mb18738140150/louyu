...
- (void)encodeWithCoder:(NSCoder *)coder
{
    ...
    [coder encodeObject:@(self.dayNum) forKey:@"dayNum"];
    [coder encodeObject:@(self.weekNum) forKey:@"weekNum"];
    [coder encodeObject:@(self.MonthNum) forKey:@"MonthNum"];
    [coder encodeObject:@(self.sliceId) forKey:@"sliceId"];
...
- (instancetype)initWithCoder:(NSCoder *)coder
{
    if (self = [super init] ) {
        ...
        self.dayNum = [[coder decodeObjectForKey:@"dayNum"] intValue];
        self.weekNum = [[coder decodeObjectForKey:@"weekNum"] intValue];
        self.MonthNum = [[coder decodeObjectForKey:@"MonthNum"] intValue];
        self.sliceId = [[coder decodeObjectForKey:@"sliceId"] intValue];
