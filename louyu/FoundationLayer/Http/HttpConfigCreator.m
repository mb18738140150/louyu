...
+ (HttpConfigModel *)registWith:(NSDictionary *)infoDic
{
    ...
    NSDictionary *dic = @{kCommand:kCommandRegist,
                          @"LoginName":[infoDic objectForKey:@"phone"],
                          @"LoginPwd":[infoDic objectForKey:@"password"],
                          };
    [self setConfigModel:c withInfo:dic];
    return c;
}
...
{
    HttpConfigModel *categoryDetailHttp = [[HttpConfigModel alloc] init];
    NSDictionary *dic = @{kCommand:kCommandCompanyList,
                          @"companyName":[infoDic objectForKey:kcompanyName],
                          @"sliceId":@([[UserManager sharedManager] getSliceId]),
                          @"page":[infoDic objectForKey:@"page"]
                          };
    [self setConfigModel:categoryDetailHttp withInfo:dic];
    return categoryDetailHttp;
}

+ (HttpConfigModel *)getMyBookmarkListConfig:(NSDictionary *)infoDic
{
    HttpConfigModel *categoryDetailHttp = [[HttpConfigModel alloc] init];
    NSDictionary *dic = @{kCommand:kCommandbuildList,
                          @"buildName":[infoDic objectForKey:kbuildName],
                          @"sliceId":@([[UserManager sharedManager] getSliceId])
                          };
    [self setConfigModel:categoryDetailHttp withInfo:dic];
    return categoryDetailHttp;
...
{
    HttpConfigModel *categoryDetailHttp = [[HttpConfigModel alloc] init];
    NSDictionary *dic = @{kCommand:kCommandAllBuildLocation,
                          @"buildName":[infoDic objectForKey:kbuildName],
                          @"sliceId":@([[infoDic objectForKey:@"sliceId"] intValue]),
                          @"typeId":[infoDic objectForKey:@"typeId"],
                          };
    [self setConfigModel:categoryDetailHttp withInfo:dic];
    return categoryDetailHttp;
}
...
{
    HttpConfigModel *categoryDetailHttp = [[HttpConfigModel alloc] init];
    NSDictionary *dic = @{kCommand:kCommandgetNavigationEndPoint
                          };
    [self setConfigModel:categoryDetailHttp withInfo:dic];
    return categoryDetailHttp;
}
...
{
    HttpConfigModel *categoryDetailHttp = [[HttpConfigModel alloc] init];
    NSDictionary *dic = @{kCommand:kCommandDepartmentList,
                          };
    [self setConfigModel:categoryDetailHttp withInfo:dic];
    return categoryDetailHttp;
}
...
{
    HttpConfigModel *categoryDetailHttp = [[HttpConfigModel alloc] init];
    NSDictionary *dic = @{kCommand:kCommandAllBuildTypeList,
                          };
    [self setConfigModel:categoryDetailHttp withInfo:dic];
    return categoryDetailHttp;
}
...
{
    HttpConfigModel *categoryDetailHttp = [[HttpConfigModel alloc] init];
    NSDictionary *dic = @{kCommand:kCommandBuildCompany,
                          @"floorNo":[infoDic objectForKey:@"floorNo"],
                          @"buildName":[infoDic objectForKey:@"buildName"],
                          @"seatNo":[infoDic objectForKey:@"seatNo"],
                          @"page":[infoDic objectForKey:@"page"]
                          };
    [self setConfigModel:categoryDetailHttp withInfo:dic];
    return categoryDetailHttp;
...
{
    HttpConfigModel *categoryDetailHttp = [[HttpConfigModel alloc] init];
    NSDictionary *dic = @{kCommand:kCommandBuildSale,
                          @"buildName":[infoDic objectForKey:@"buildName"],
                          @"page":[infoDic objectForKey:@"page"]
                          };
    [self setConfigModel:categoryDetailHttp withInfo:dic];
...
+ (HttpConfigModel *)getChangeIconImageConfig:(NSDictionary *)infoDic
{
    ...
    NSDictionary *dic = @{kCommand:kCommandChangeIconImage,
                          @"imgPath":[infoDic objectForKey:@"imgPath"]
                          };
    [self setConfigModel:categoryDetailHttp withInfo:dic];
    return categoryDetailHttp;
}
...
+ (HttpConfigModel *)getChangeGenderConfig:(NSDictionary *)infoDic
{
    ...
    NSDictionary *dic = @{kCommand:kCommandChangeGender,
                          @"type":@"icon",
                          @"imgFile":[infoDic objectForKey:@"imgFile"]
                          };
    [self setConfigModel:categoryDetailHttp withInfo:dic];
    return categoryDetailHttp;
}
...
{
    HttpConfigModel *categoryDetailHttp = [[HttpConfigModel alloc] init];
    NSDictionary *dic = @{kCommand:kCommandAddCompany,
                          @"sliceId":[infoDic objectForKey:@"sliceId"],
                          kbuildName:[infoDic objectForKey:kbuildName],
                          @"seatNo":[infoDic objectForKey:@"seatNo"],
                          @"community":[infoDic objectForKey:@"community"],
                          @"companyArea":[infoDic objectForKey:@"companyArea"],
                          @"industry":[infoDic objectForKey:@"industry"],
                          @"companyName":[infoDic objectForKey:@"companyName"],
                          @"belongTime":[infoDic objectForKey:@"belongTime"],
                          @"companyLicense":[infoDic objectForKey:@"companyLicense"],
                          @"companyTax":[infoDic objectForKey:@"companyTax"],
                          @"companyCredit":[infoDic objectForKey:@"companyCredit"],
                          @"regAddress":[infoDic objectForKey:@"regAddress"],
                          @"economicType":[infoDic objectForKey:@"economicType"],
                          @"legalPerson":[infoDic objectForKey:@"legalPerson"],
                          @"headPerson":[infoDic objectForKey:@"headPerson"],
                          @"legalPhone":[infoDic objectForKey:@"legalPhone"],
                          @"taxAgency":[infoDic objectForKey:@"taxAgency"],
                          @"emptyAccount":[infoDic objectForKey:@"emptyAccount"],
                          @"productType":[infoDic objectForKey:@"productType"],
                          @"inTime":[infoDic objectForKey:@"inTime"],
                          @"roomMaster":[infoDic objectForKey:@"roomMaster"],
                          @"floorNo":[infoDic objectForKey:@"floorNo"],
                          @"roomNo":[infoDic objectForKey:@"roomNo"],
                          @"employNum":[infoDic objectForKey:@"employNum"],
                          @"monthRent":[infoDic objectForKey:@"monthRent"],
                          @"companyType":[infoDic objectForKey:@"companyType"],
                          @"listedType":[infoDic objectForKey:@"listedType"],
                          @"contactPerson":[infoDic objectForKey:@"contactPerson"],
                          @"contactPhone":[infoDic objectForKey:@"contactPhone"],
                          @"regMoney":[infoDic objectForKey:@"regMoney"],
                          };
    [self setConfigModel:categoryDetailHttp withInfo:dic];
    return categoryDetailHttp;
}
