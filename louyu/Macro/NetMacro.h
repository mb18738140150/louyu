...
// 会计教练
#define kRootUrl @"http://120.194.7.116:8081/handle/getdata.ashx"
#define kDomainName  @"http://120.194.7.116:8081"

#define kImageUrl @"http://120.194.7.116:8081/upload"

#define kMD5String @"qianshutang"

#define kUploadRootUrl @"http://120.194.7.116:8081/handle/multiplefile.ashx"
...
#define kCommandSearchMyCollectionTextBook      @"2"
#define kCommandMyQuestionList          @"3"
#define kCommandAddCompany   @"4"
#define kCommandCompanyList             @"5"
#define kCommandbuildList               @"6"

#define kCommandResetPwd                @"7"
#define kCommandChangeGender            @"8"
#define kCommandChangeIconImage         @"9"
#define kCommandAllBuildTypeList      @"11"
#define kCommandAllBuildLocation        @"12"
#define kCommandBuildCompany        @"13"
#define kCommandBuildSale     @"14"
#define kCommandgetNavigationEndPoint    @"15"
#define kCommandDepartmentList      @"16"
#define kCommandRegist                  @"17"
